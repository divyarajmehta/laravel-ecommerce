...
@section('main-container')
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
                                ...
                                <div class="card-body p-b-20">
                                    <div class="list-group">
                                        <a class="list-group-item media" href="">
                                             <div class="pull-left">
                                                <img class="lg-item-img" src="{{url('admin_side/images/in1.jpg')}}" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                                	<div class="lg-item-heading">Bhavya</div>
                                                	<small class="lg-item-text">bhavyajustchill@gmail.com</small>
                                                </div>
                                                <div class="pull-right">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="{{url('admin_side/images/in2.jpg')}}" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="{{url('admin_side/images/in3.jpg')}}" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="{{url('admin_side/images/in4.jpg')}}" alt="">
                                            </div>
                                            <div class="media-body">
                                            	<div class="pull-left">
