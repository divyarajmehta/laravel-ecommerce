				...
				<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="{{url('client_side/images/sii1.jpg')}}">
									<div class="thumb-image">
										<img src="{{url('client_side/images/sii1.jpg')}}" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								<li data-thumb="{{url('client_side/images/sii2.jpg')}}">
									<div class="thumb-image">
										<img src="{{url('client_side/images/sii2.jpg')}}" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								<li data-thumb="{{url('client_side/images/sii3.jpg')}}">
									<div class="thumb-image">
										<img src="{{url('client_side/images/sii3.jpg')}}" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
							</ul>
