			...
			<div class="row contact-grids agile-1 mb-5">
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a href="mailto:info@example.com">divyarajmehta7698@gmail.com</a>
							<label>
								<a href="mailto:info@example.com">vrundavadaliya@gmail.com</a>
							</label>
						</p>
					</div>
				</div>
